...
\newcommand{\lblReparte}{Reparte}
\newcommand{\lblCompra}{La compra}
\newcommand{\lblProblema}{Problema}
\newcommand{\lblBotes}{Los tres botes}
\newcommand{\lblHucha}{La hucha}
\newcommand{\lblLlega}{¿Me llega?}
\newcommand{\lblVuelta}{La vuelta}
\newcommand{\lblOrdena}{Ordena}
\newcommand{\lblElige}{Elige}
\newcommand{\lblCompara}{Compara}
\newcommand{\lblCuentas}{Las cuentas}
% Las columnas del cuaderno de cuentas.
\newcommand{\lblQuePasa}{Qué pasa}
\newcommand{\lblEntra}{Entra}
\newcommand{\lblSale}{Sale}
\newcommand{\lblQueda}{Queda}
\newcommand{\lblAlEmpezar}{Al empezar}

% El dinero en los dibujos (las etiquetas de precio, las monedas y los
% billetes): el número y, detrás, el euro.
\newcommand{\importe}[1]{#1\,€}

% Los nombres de los tres botes.
\newcommand{\lblAhorrar}{Ahorrar}
\newcommand{\lblGastar}{Gastar}
\newcommand{\lblCompartir}{Compartir}
