...
# preamble.tex). "First Economics", el mismo cuaderno en inglés, página a
# página: english.tex y english-bw.tex, con \booklang{english} (ver
# tools/idiomas.py); y "Poznaję ekonomię", en polaco: polish.tex y
...
clean:
	...
	rm -f content/english/generated-days.tex content/english/generated-clave.tex \
	      content/english/generated-diccionario.tex
	rm -f content/polish/generated-days.tex content/polish/generated-clave.tex \
	      content/polish/generated-diccionario.tex
