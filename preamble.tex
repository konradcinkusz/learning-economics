...
% La lengua del cuaderno: english.tex (y english-bw.tex) fija
% \booklang{english} antes de \input{preamble}, como \bookcolor, y el
% mismo preámbulo compone "First Economics": el mismo cuaderno, en
% inglés, con sus cadenas de texto en lang/en.tex en vez de lang/es.tex
% (como en "First Numbers", de "Aprendo los números"); polish.tex fija
% \booklang{polish}, y compone "Poznaję ekonomię", con lang/pl.tex.
\makeatletter
\newif\ifenglishbook
\newif\ifpolishbook
\def\aln@booklang@english{english}
\def\aln@booklang@polish{polish}
\@ifundefined{booklang}{\englishbookfalse\polishbookfalse}{%
  \ifx\booklang\aln@booklang@english \englishbooktrue \else \englishbookfalse \fi
  \ifx\booklang\aln@booklang@polish \polishbooktrue \else \polishbookfalse \fi
}
\makeatother
...
\else\ifpolishbook
  ...
  % babel-polish también hace de " un carácter activo (como
  % babel-spanish, más abajo).
  \AtBeginDocument{\shorthandoff{"}}
\else
  \usepackage[spanish]{babel}
  % babel-spanish hace de " un carácter activo; las comillas escritas a
  % mano en el texto se estropean sin esto (ver el mismo comentario, más
  % largo, en el preamble.tex de "Aprendo a leer"). Solo funciona así, al
...
% --- cadenas de texto ----------------------------------------------------
\ifenglishbook \input{lang/en} \else\ifpolishbook \input{lang/pl} \else \input{lang/es} \fi\fi
...
% Las del dinero, que llegan con el otoño.
\cajaActividad{cajaDinero}{\lblDinero}{colorRelaciona}
\cajaActividad{cajaReparte}{\lblReparte}{colorCompleta}
\cajaActividad{cajaCompra}{\lblCompra}{colorDibuja}
\cajaActividad{cajaProblema}{\lblProblema}{colorLectura}
\cajaActividad{cajaBotes}{\lblBotes}{colorResponde}
\cajaActividad{cajaHucha}{\lblHucha}{colorResponde}
\cajaActividad{cajaLlega}{\lblLlega}{colorRelaciona}
\cajaActividad{cajaVuelta}{\lblVuelta}{colorCompleta}
\cajaActividad{cajaOrdena}{\lblOrdena}{colorDibuja}
% Las del invierno.
\cajaActividad{cajaElige}{\lblElige}{colorResponde}
\cajaActividad{cajaCompara}{\lblCompara}{colorDibuja}
% La de la primavera.
\cajaActividad{cajaCuentas}{\lblCuentas}{colorLectura}
...
% Una casilla más baja, para las filas del cuaderno de cuentas.
\newcommand{\casillaCuenta}[1][22mm]{\raisebox{-4mm}{\tikz\draw[line width=1.1pt,
  rounded corners=1.5mm, fill=white] (0,0) rectangle (#1,12.5mm);}}
